...
export class PersonServiceProxy {
     ...
     * @return Success
     */
    getPaged(filterText: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfPersonListDto> {
        let url_ = this.baseUrl + "/api/services/app/Person/GetPaged?";
    ...
    protected processGetPaged(response: HttpResponseBase): Observable<PagedResultDtoOfPersonListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfPersonListDto.fromJS(resultData200) : new PagedResultDtoOfPersonListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    getById(id: number | null | undefined): Observable<PersonListDto> {
        let url_ = this.baseUrl + "/api/services/app/Person/GetById?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PersonListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PersonListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetById(response: HttpResponseBase): Observable<PersonListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PersonListDto.fromJS(resultData200) : new PersonListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PersonListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<GetPersonForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/Person/GetForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetForEdit(response: HttpResponseBase): Observable<GetPersonForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    createOrUpdate(input: CreateOrUpdatePersonInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Person/CreateOrUpdate";
        url_ = url_.replace(/[?&]$/, "");
    ...
    batchDelete(input: number[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Person/BatchDelete";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class PhoneNumberServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getPaged(filterText: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfPhoneNumberListDto> {
        let url_ = this.baseUrl + "/api/services/app/PhoneNumber/GetPaged?";
        if (filterText !== undefined)
            url_ += "FilterText=" + encodeURIComponent("" + filterText) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfPhoneNumberListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfPhoneNumberListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetPaged(response: HttpResponseBase): Observable<PagedResultDtoOfPhoneNumberListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfPhoneNumberListDto.fromJS(resultData200) : new PagedResultDtoOfPhoneNumberListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfPhoneNumberListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getById(id: number | null | undefined): Observable<PhoneNumberListDto> {
        let url_ = this.baseUrl + "/api/services/app/PhoneNumber/GetById?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PhoneNumberListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PhoneNumberListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetById(response: HttpResponseBase): Observable<PhoneNumberListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<PhoneNumberListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<GetPhoneNumberForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/PhoneNumber/GetForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetPhoneNumberForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetPhoneNumberForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<GetPhoneNumberForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetPhoneNumberForEditOutput.fromJS(resultData200) : new GetPhoneNumberForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetPhoneNumberForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrUpdate(input: CreateOrUpdatePhoneNumberInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/PhoneNumber/CreateOrUpdate";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/PhoneNumber/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    batchDelete(input: number[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/PhoneNumber/BatchDelete";
        url_ = url_.replace(/[?&]$/, "");
...
export class PagedResultDtoOfPersonListDto implements IPagedResultDtoOfPersonListDto {
    ...
    clone(): PagedResultDtoOfPersonListDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfPersonListDto();
        result.init(json);
        return result;
...
export class CreateOrUpdatePersonInput implements ICreateOrUpdatePersonInput {
    ...
    constructor(data?: ICreateOrUpdatePersonInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.person = data["person"] ? PersonEditDto.fromJS(data["person"]) : new PersonEditDto();
        }
    }

    static fromJS(data: any): CreateOrUpdatePersonInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrUpdatePersonInput();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateOrUpdatePersonInput {
        const json = this.toJSON();
        let result = new CreateOrUpdatePersonInput();
        result.init(json);
        return result;
...
export interface ICreateOrUpdatePersonInput {
    person: PersonEditDto;
}

export class PagedResultDtoOfPhoneNumberListDto implements IPagedResultDtoOfPhoneNumberListDto {
    totalCount: number | undefined;
    items: PhoneNumberListDto[] | undefined;

    constructor(data?: IPagedResultDtoOfPhoneNumberListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(PhoneNumberListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfPhoneNumberListDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfPhoneNumberListDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfPhoneNumberListDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfPhoneNumberListDto();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfPhoneNumberListDto {
    totalCount: number | undefined;
    items: PhoneNumberListDto[] | undefined;
}
...
export class GetPhoneNumberForEditOutput implements IGetPhoneNumberForEditOutput {
    phoneNumber: PhoneNumberEditDto | undefined;

    constructor(data?: IGetPhoneNumberForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.phoneNumber = data["phoneNumber"] ? PhoneNumberEditDto.fromJS(data["phoneNumber"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetPhoneNumberForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetPhoneNumberForEditOutput();
        result.init(data);
        return result;
    }
    ...
    clone(): GetPhoneNumberForEditOutput {
        const json = this.toJSON();
        let result = new GetPhoneNumberForEditOutput();
        result.init(json);
        return result;
...
export interface IGetPhoneNumberForEditOutput {
    phoneNumber: PhoneNumberEditDto | undefined;
}
...
export class CreateOrUpdatePhoneNumberInput implements ICreateOrUpdatePhoneNumberInput {
    phoneNumber: PhoneNumberEditDto;

    constructor(data?: ICreateOrUpdatePhoneNumberInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.phoneNumber = new PhoneNumberEditDto();
        }
    }

    init(data?: any) {
        if (data) {
            this.phoneNumber = data["phoneNumber"] ? PhoneNumberEditDto.fromJS(data["phoneNumber"]) : new PhoneNumberEditDto();
        }
    }

    static fromJS(data: any): CreateOrUpdatePhoneNumberInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrUpdatePhoneNumberInput();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateOrUpdatePhoneNumberInput {
        const json = this.toJSON();
        let result = new CreateOrUpdatePhoneNumberInput();
        result.init(json);
        return result;
...
export interface ICreateOrUpdatePhoneNumberInput {
    phoneNumber: PhoneNumberEditDto;
}
