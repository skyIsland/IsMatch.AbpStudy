...
复制以下代码到Application层下的：AbpStudyApplicationModule.cs
...
如果你生成了**权限功能**。复制以下代码到 AbpStudyApplicationModule.cs
中的 PreInitialize 方法中:
...
<text name="PhoneNumber" value=""></text><text name="QueryPhoneNumber"  value="查询"></text><text name="CreatePhoneNumber"  value="添加"></text><text name="EditPhoneNumber"  value="编辑"></text><text name="DeletePhoneNumber"  value="删除"></text><text name="BatchDeletePhoneNumber" value="批量删除"></text><text name="ExportPhoneNumber"  value="导出"></text>                             
